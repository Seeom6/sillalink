...
export const ProjectsTableHeader = memo(({ search, status, onSearchChange, onStatusChange, onAddUser }: TableFiltersProps) => {
  return (
...
ProjectsTableHeader.displayName = "TableFilters"
